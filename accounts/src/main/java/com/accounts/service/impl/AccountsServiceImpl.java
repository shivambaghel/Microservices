...
import com.accounts.dto.AccountsMsgDto;
...
public class AccountsServiceImpl implements IAccountsService {
    ...
    public void createAccount(CustomerDto customerDto) {
        ...
        Accounts savedAccount = accountsRepository.save(createNewAccount(savedCustomer)); // Create new account for the customer
        sendCommunication(savedAccount, savedCustomer); // triggering an event
    }
